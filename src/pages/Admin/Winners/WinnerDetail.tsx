...
export default function WinnerDetail() {
  ...
  const getWinTypeBadge = (winType: string) => {
    const badges: Record<string, { label: string; color: string }> = {
      instant_win: { label: 'Instant Win', color: 'bg-admin-info-bg text-admin-info-fg' },
      end_prize: { label: 'End Prize', color: 'bg-admin-purple-bg text-admin-purple-fg' },
      manual: { label: 'Manual', color: 'bg-admin-gray-bg text-admin-gray-text' },
    }
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <Link
              ...
              className="mt-4 inline-flex items-center gap-2 text-admin-info-fg hover:text-admin-info-text cursor-pointer"
            >
    ...
    <>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              variant="outline"
              className="bg-admin-error-text text-white hover:bg-admin-error-light cursor-pointer"
            >
          ...
          <div className="bg-admin-card-bg border border-border rounded-lg p-6">
            <div className="flex items-start gap-6">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3">
                  ...
                  {winner.is_public && (
                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-admin-success-bg text-admin-success-fg">
                      Public
                    </span>
                  )}
                  {winner.featured && (
                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-admin-info-bg text-admin-info-fg">
                      Featured
                    </span>
                  )}
                </div>
            ...
            {winner.testimonial && (
              <div className="mt-6 p-4 bg-admin-hover-bg rounded-lg border border-border">
          ...
          <div className="bg-admin-card-bg border border-border rounded-lg p-6">
            ...
            <div className="space-y-4">
              <label className="flex items-center justify-between cursor-pointer">
                <div className="flex items-center gap-3">
                  <div className={`p-2 rounded-lg ${isPublic ? 'bg-admin-success-bg' : 'bg-admin-gray-bg'}`}>
                    {isPublic ? (
              ...
              <label className="flex items-center justify-between cursor-pointer">
                <div className="flex items-center gap-3">
                  <div className={`p-2 rounded-lg ${featured ? 'bg-admin-success-bg' : 'bg-admin-gray-bg'}`}>
                    <Star className={`size-4 ${featured ? 'text-admin-success-fg' : 'text-muted-foreground'}`} />
                  </div>
                  <div>
              ...
              <label className="flex items-center justify-between cursor-pointer">
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-admin-success-bg rounded-lg">
                    <Trophy className={`size-4 ${showInTicker ? 'text-admin-success-fg' : 'text-muted-foreground'}`} />
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-3">
                  <label className="cursor-pointer">
                    <input
                      ...
                      className="hidden"
                    />
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-admin-hover-bg hover:bg-admin-gray-bg rounded-lg transition-colors text-sm font-medium cursor-pointer">
                      <Upload className="size-4" />
                      {uploadingPhoto ? 'Uploading...' : 'Upload Photo'}
                    </div>
                  </label>
                  {winner.winner_photo_url && (
                    <span className="text-sm text-admin-success-fg flex items-center gap-1">
              ...
              <div className="space-y-4">
                ...
                {winner.prize_value_gbp && (
                  <div>
                    ...
                    <div className="text-2xl font-semibold text-admin-success-fg">
                ...
                {winner.competition && (
                  <>
                    ...
                    <Link
                      ...
                      className="inline-flex items-center gap-2 text-admin-info-fg hover:text-admin-info-text text-sm font-medium cursor-pointer"
                    >
            ...
            <div className="bg-admin-card-bg border border-border rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="md:col-span-3">
                  ...
                  <div className="font-mono text-xs break-all bg-admin-hover-bg p-2 rounded">
          ...
          {winner.user && (
            <div className="bg-admin-card-bg border border-border rounded-lg p-6">
              ...
              <Link
                ...
                className="mt-4 inline-flex items-center gap-2 text-admin-info-fg hover:text-admin-info-text text-sm font-medium cursor-pointer"
              >
                View User Profile →
              </Link>
            </div>
              ...
              <div className="space-y-4">
                ...
                {fulfillment.choice === 'cash' ? (
                  <>
                    ...
                    {(fulfillment.status === 'cash_selected' || fulfillment.status === 'processing') && (
                      <div className="p-4 bg-admin-hover-bg border border-border rounded-lg">
                ...
                <div className="border-t border-border pt-4">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    {fulfillment.notified_at && (
                      <div className="flex items-center gap-2">
                        <Mail className="size-4 text-admin-info-fg" />
                    ...
                    {fulfillment.choice !== 'cash' && fulfillment.dispatched_at && (
                      <div className="flex items-center gap-2">
                        <Package className="size-4 text-admin-purple-fg" />
                    ...
                    {fulfillment.choice !== 'cash' && (
                      <div className="flex items-center gap-2">
                        <Clock className="size-4 text-admin-orange-fg" />
                ...
                {fulfillment.choice !== 'cash' && fulfillment.delivery_address && (
                  <div className="border-t border-border pt-4">
                    ...
                    <div className="p-3 bg-admin-hover-bg rounded-lg text-sm">
          ...
          {/* Metadata */}
          <div className="bg-admin-card-bg border border-border rounded-lg p-4 text-xs text-muted-foreground space-y-1">
            <div>
      ...
      <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4">
            {/* Winner Info */}
            <div className="flex items-center gap-3 p-4 bg-admin-hover-bg border border-border rounded-lg">
              {winner.prize_image_url ? (
                <img
                  src={winner.prize_image_url}
                  alt={winner.display_name}
            ...
            <div className="flex items-center justify-end gap-3 pt-2">
              ...
              <Button
                ...
                disabled={deleting}
                className="bg-admin-error-text hover:bg-admin-error-light text-white cursor-pointer"
              >
