...
export default function HowItWorks() {
  ...
  return (
    <div className="antialiased relative min-h-screen" style={{ color: '#2D251E', backgroundColor: '#fffbf7' }}>
      ...
      <section className="py-20 border-t" style={{ backgroundColor: 'white', borderColor: '#e7e5e4' }}>
        <div className="max-w-[1300px] mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-4xl font-bold mb-6" style={{ fontFamily: "'Fraunces', serif", color: '#151e20' }}>
              Fairness Guaranteed
            </h2>
            ...
            <ul className="space-y-4 inline-block text-left">
              {[
                ...
                <li key={i} className="flex items-center gap-3 font-medium" style={{ color: '#151e20' }}>
                  <CheckCircle className="shrink-0" size={20} style={{ color: '#496B71' }} aria-hidden="true" />
                  {item}
                </li>
              ))}
            </ul>
      ...
      {/* FAQ Teaser Section */}
      <section className="py-20 text-center" style={{ backgroundColor: '#fffbf7' }}>
        <div className="max-w-2xl mx-auto px-6">
          <HelpCircle className="mx-auto mb-4" size={48} style={{ color: '#78716c' }} aria-hidden="true" />
          <h2 className="text-3xl font-bold mb-4" style={{ fontFamily: "'Fraunces', serif", color: '#151e20' }}>
          ...
          <Link to="/faq">
            <button
              className="px-8 py-3 rounded-xl font-semibold text-base transition-colors cursor-pointer"
              style={{
                backgroundColor: 'white',
                color: '#151e20',
                borderWidth: '1px',
