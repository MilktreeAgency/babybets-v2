...
export default function PartnerProfile() {
  ...
  const getPlatformIcon = (platform: string) => {
    switch (platform) {
      case 'Instagram':
        return <Instagram size={18} className="sm:w-5 sm:h-5" />
      case 'YouTube':
        return <Youtube size={18} className="sm:w-5 sm:h-5" />
      case 'TikTok':
        return (
          <svg className="w-[18px] h-[18px] sm:w-5 sm:h-5" viewBox="0 0 24 24" fill="currentColor">
  ...
  if (!influencer) {
    return (
      <div className="min-h-screen" style={{ backgroundColor: '#fffbf7', color: '#2D251E' }}>
        <Header />
        <div className="pt-24 sm:pt-28 md:pt-32 px-4 sm:px-6 text-center">
          <h1 className="text-xl sm:text-2xl font-bold mb-1.5 sm:mb-2">Partner Not Found</h1>
          <p className="text-sm sm:text-base text-gray-600 mb-5 sm:mb-6">The partner profile you're looking for doesn't exist.</p>
          <Link
            to="/"
            className="inline-flex items-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 text-sm sm:text-base rounded-lg font-bold transition-colors cursor-pointer"
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#fffbf7', color: '#2D251E' }}>
      ...
      {/* Profile Section */}
      <div className="pt-12 sm:pt-14 md:pt-16 pb-8 sm:pb-9 md:pb-10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-[200px_1fr] gap-6 sm:gap-7 md:gap-8 items-start">
            {/* Profile Image */}
              ...
              <div className="relative mb-3 sm:mb-4">
                {influencer.profile_image_url ? (
                  <img
                    ...
                    className="size-32 sm:size-36 md:size-40 rounded-full object-cover shadow-lg"
                    style={{ borderWidth: '4px', borderColor: 'white' }}
                  />
                ) : (
                  <div
                    className="size-32 sm:size-36 md:size-40 rounded-full shadow-lg flex items-center justify-center text-3xl sm:text-4xl font-bold"
                    style={{
                      borderWidth: '4px',
                      borderColor: 'white',
            ...
            {/* Bio & Info */}
            <div>
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-2.5 sm:mb-3" style={{ fontFamily: "'Fraunces', serif", color: '#151e20' }}>
                {influencer.display_name}
              </h1>

              <p className="text-sm sm:text-base leading-relaxed mb-3 sm:mb-4" style={{ color: '#78716c' }}>
              ...
              <div className="inline-flex items-center gap-2">
                <div>
                  ...
                  <span className="text-xs sm:text-sm font-bold ml-1" style={{ color: '#151e20' }}>
                    {influencer.slug}
                  </span>
                </div>
                <button
      ...
      <div className="pb-10 sm:pb-11 md:pb-12">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12">
          <div className="mb-5 sm:mb-6">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold" style={{ fontFamily: "'Fraunces', serif", color: '#151e20' }}>
              Active Competitions
            </h2>
            <p className="mt-1.5 sm:mt-2 text-xs sm:text-sm" style={{ color: '#78716c' }}>
          ...
          {competitions.length === 0 ? (
            <div
              className="text-center py-12 sm:py-14 md:py-16 rounded-2xl px-4"
