      ...
      <div className="flex-1 overflow-y-auto pt-4 sm:pt-6 pb-6 sm:pb-8 px-4 sm:px-6">
        <div className="max-w-[1300px] mx-auto">
              ...
              {navigationItems.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-3 py-2 rounded-lg font-semibold transition-colors cursor-pointer whitespace-nowrap text-sm ${
                      item.id === 'logout'
                  ...
                  >
                    ...
                    {'badge' in item && item.badge && (
                      <span className="inline-flex items-center justify-center px-1.5 py-0.5 text-xs font-bold rounded-full" style={{ backgroundColor: '#f25100', color: 'white' }}>
                        {item.badge}
                      </span>
                    )}
                  </button>
          ...
          <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-8 lg:items-start">
            ...
            <div className="hidden lg:block lg:w-82 shrink-0">
              <div className="bg-white rounded-xl p-3 sm:p-4 lg:sticky lg:top-8 overflow-y-auto">
