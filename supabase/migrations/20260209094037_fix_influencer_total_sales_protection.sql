-- Fix influencer protection trigger to allow total_sales_pence updates from create_influencer_sale()
...
BEGIN
  ...
  -- Case 1: All stats fields being updated together with commission_tier
  -- (from recalculate_monthly_commissions)
  IF (
  ...
  -- Case 3: monthly_sales_pence and total_commission_pence being updated together
