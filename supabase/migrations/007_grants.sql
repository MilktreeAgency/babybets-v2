...
GRANT EXECUTE ON FUNCTION public.calculate_commission_tier(INTEGER) TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_commission_rate(INTEGER) TO authenticated;
GRANT EXECUTE ON FUNCTION public.recalculate_monthly_commissions(UUID) TO authenticated;
GRANT EXECUTE ON FUNCTION public.reset_monthly_influencer_sales() TO authenticated;
...
GRANT EXECUTE ON FUNCTION public.generate_alphanumeric_code(INTEGER) TO authenticated;
GRANT EXECUTE ON FUNCTION public.generate_random_ticket_numbers(UUID, INTEGER) TO authenticated;
GRANT EXECUTE ON FUNCTION public.generate_ticket_pool(UUID) TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_ticket_pool_stats(UUID) TO authenticated;
