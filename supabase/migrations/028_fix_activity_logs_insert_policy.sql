-- Fix all activity log trigger functions to use SECURITY DEFINER
-- This allows them to bypass RLS policies when inserting activity logs

-- Fix log_order_activity to use SECURITY DEFINER
...
-- Fix log_winner_activity to use SECURITY DEFINER
...
-- Fix log_signup_activity to use SECURITY DEFINER
...
-- Fix log_fulfillment_activity to use SECURITY DEFINER
...
-- Fix log_withdrawal_activity to use SECURITY DEFINER
...
-- Fix log_draw_audit_activity to use SECURITY DEFINER
