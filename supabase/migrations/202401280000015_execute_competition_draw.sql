-- ============================================
-- RPC FUNCTION: execute_competition_draw
-- Description: Executes a cryptographically secure competition draw
-- Security: Admin only
-- ============================================
...
COMMENT ON FUNCTION public.execute_competition_draw IS 'Executes a cryptographically secure competition draw (admin only)';
