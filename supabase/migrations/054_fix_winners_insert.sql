-- ============================================
-- FIX WINNERS INSERT
-- Description: Use correct winners table columns
-- Date: 2026-02-13
-- ============================================
...
BEGIN
  ...
  -- Get all sold ticket IDs for this competition
  ...
  -- Create cryptographic hash of ticket pool
  ...
  -- Get winning ticket with user info
  ...
  -- Create winner record with CORRECT columns
  INSERT INTO winners (
    user_id,
    display_name,
    prize_name,
...
COMMENT ON FUNCTION public.execute_competition_draw_internal IS
  'Internal function for executing draws. Final corrected version with all proper table schemas.';
