-- ============================================
-- ALLOW SYSTEM FUNCTIONS TO UPDATE COMMISSION TIER
-- Description: Fix the protect_influencer_critical_fields trigger to allow
--              SECURITY DEFINER functions to update commission_tier
-- Version: 1.0
-- ============================================

-- Update the trigger function to allow SECURITY DEFINER functions to modify protected fields
