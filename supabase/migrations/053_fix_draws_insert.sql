-- ============================================
-- FIX DRAWS INSERT
-- Description: Add missing random_seed and winning_user_id columns
-- Date: 2026-02-13
-- ============================================
...
BEGIN
  ...
  -- Record the draw with ALL required columns
  INSERT INTO draws (
    competition_id,
    snapshot_id,
    random_seed,
...
COMMENT ON FUNCTION public.execute_competition_draw_internal IS
  'Internal function for executing draws. Correctly uses all draw table columns. Bypasses admin check for automated execution.';
